...
<main id="main" tabindex="-1" class="error-page">
  <div class="error-page__copy">
    ...
    <p>
      {page.status === 404
        ? 'Перейдите к нужному типу объекта или передайте исходные данные проекта.'
        : 'Вернитесь к основным направлениям или сообщите нам о задаче через форму проекта.'}
    </p>
    <a class="button button--primary" href="/modulnye-zdaniya/#project-brief">Рассчитать стоимость</a>
  </div>
