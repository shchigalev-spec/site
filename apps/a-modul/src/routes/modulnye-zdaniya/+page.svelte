...
<svelte:head>
  ...
  <link rel="preload" as="image" href="/generated/a-modul-general-hero-operational-object-first-screen-mobile.avif" type="image/avif" media="(max-width: 820px)" fetchpriority="high" />
